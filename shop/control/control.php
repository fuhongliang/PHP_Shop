...
class Control
{
    ...
    protected function getMemberAndGradeInfo($is_return = false)
    {
        ...
        if ($_SESSION['member_id']) {
            ...
            if ($member_info) {
                $member_grade_info = $model_member->getOneMemberGrade(intval($member_info['member_exppoints']));
